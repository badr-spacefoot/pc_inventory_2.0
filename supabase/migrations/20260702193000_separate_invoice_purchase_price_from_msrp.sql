...
set
  estimated_launch_price = null,
  notes = trim(coalesce(notes, '') || ' Invoice purchase price was separated from launch/MSRP price.')
where valuation_method = 'invoice_backed'
  and estimated_launch_price is not null
  and raw_data ? 'invoice'
