...
export const englishTranslations = {
  ...
  "Activer votre compte": "Activate your account",
  "Vérifiez votre invitation puis choisissez votre mot de passe.": "Review your invitation, then choose your password.",
  "Vérification de l'invitation...": "Checking invitation...",
  "Lien d'invitation indisponible": "Invitation link unavailable",
  ...
  "Le rôle est fixé ici. L'utilisateur choisira son mot de passe depuis le lien sécurisé.":
    "Set the role here. The user will choose their password through the secure link.",
  "Validité du lien": "Link validity",
  "3 jours": "3 days",
  "14 jours": "14 days",
  "Créer le lien d'invitation": "Create invitation link",
  "Lien prêt à envoyer": "Link ready to send",
  "Ce lien est personnel, temporaire et utilisable une seule fois.":
    "This link is personal, temporary, and can only be used once.",
  "Invitations de compte": "Account invitations",
  "Suivez les liens en attente, acceptés, expirés ou révoqués.": "Track pending, accepted, expired, or revoked links.",
  "Création et modification manuelles": "Manual account creation and editing",
  "Réservé aux interventions administratives et aux réinitialisations de mot de passe.":
    "For administrative maintenance and password resets only.",
  Comptes: "Accounts",
  Copier: "Copy",
  ...
  Expirée: "Expired",
  Révoquée: "Revoked",
  "Aucune invitation de compte.": "No account invitations.",
  "Invitation de compte créée.": "Account invitation created.",
  "Invitation de compte révoquée.": "Account invitation revoked.",
  "Nouveau lien d'invitation créé.": "New invitation link created.",
  "Module invitations de compte indisponible": "Account invitations unavailable",
  "Invitation de compte introuvable.": "Account invitation not found.",
  "Invitation de compte déjà utilisée.": "This account invitation has already been used.",
  "Invitation de compte expirée.": "This account invitation has expired.",
  "Invitation de compte indisponible.": "This account invitation is unavailable.",
  "Mot de passe requis.": "Password is required.",
  "Mot de passe trop court : 10 caractères minimum.": "Password is too short: at least 10 characters.",
  "Les mots de passe ne correspondent pas.": "Passwords do not match.",
  "Un compte utilise déjà cet identifiant ou email.": "An account already uses this username or email.",
  "Une invitation active existe déjà pour cet utilisateur.": "An active invitation already exists for this user.",
  "Identifiant requis.": "Username is required.",
  "L'identifiant doit contenir entre 3 et 80 caractères : lettres minuscules, chiffres, point, tiret ou underscore.":
    "The username must contain 3 to 80 characters: lowercase letters, numbers, dots, hyphens, or underscores.",
  "Nom affiché requis.": "Display name is required.",
  "Email requis.": "Email is required.",
